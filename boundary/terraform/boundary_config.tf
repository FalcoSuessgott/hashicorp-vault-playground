...
#   ca_cert = file("${path.root}/vault-tls/output/ca.crt")
# }
...
# resource "boundary_host" "minikube" {
#   type        = "static"
#   name        = "minikube"
...
#   host_catalog_id = boundary_host_catalog_static.this.id
#   host_ids        = [boundary_host.minikube.id]
...
#     "id=${boundary_target.this.id};actions=authorize-session"
#   ]
